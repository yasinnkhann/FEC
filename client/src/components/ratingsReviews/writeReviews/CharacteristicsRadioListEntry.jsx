...
const CharacteristicsRadioListEntry = ({ characteristicID, characteristic, characteristicsRadioClick }) => (
  <div>
    <div style={containerStyle}><b style={{color: 'red'}}> * </b>{`${characteristic}`}</div>
    <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
      <div style={centerFlex}>
        <input type="radio" id={`${characteristic}1`} name={characteristicID} value="1" onClick={characteristicsRadioClick} />
      ...
      <div style={centerFlex}>
        <input type="radio" id={`${characteristic}2`} name={characteristicID} value="2" onClick={characteristicsRadioClick} />
      ...
      <div style={centerFlex}>
        <input type="radio" id={`${characteristic}3`} name={characteristicID} value="3" onClick={characteristicsRadioClick} />
      ...
      <div style={centerFlex}>
        <input type="radio" id={`${characteristic}4`} name={characteristicID} value="4" onClick={characteristicsRadioClick} />
      ...
      <div style={centerFlex}>
        <input type="radio" id={`${characteristic}5`} name={characteristicID} value="5" onClick={characteristicsRadioClick} />
